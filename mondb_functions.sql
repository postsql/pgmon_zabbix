...
/*
server total info from pg_stat_database
*/
...
/*
per-database total info from pg_stat_database
*/
...
/*
tablespace sizes and free space
...
needs change in postgresql.conf 
...
/*
per-database totals for table and index integer parameters from pg_stat(io)_user_(indexes|tables)
*/
